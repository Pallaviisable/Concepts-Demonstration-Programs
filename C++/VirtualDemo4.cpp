////////////////////////////////////////////////////////////
//
//  File Name  : VirtualDemo4.cpp
//  Description: This program demonstrates the use of virtual 
//               functions in C++. It shows how upcasting 
//               works with virtual and non-virtual functions, 
//               and the effect on object size due to the 
...
int main()
{
    cout << sizeof(Base) << "\n";              // Size of Base class object (Output: 16 due to vptr)
    cout << sizeof(Derived) << "\n";           // Size of Derived class object (Output: 20)
